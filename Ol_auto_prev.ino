...
const char* ntpServer = "2.in.pool.ntp.org";
const long  gmtOffset_sec = 19820; // UTC +5 Timezone
...
unsigned long sleepDelay = 5000; //Delay before OLED_Monitor/TV screensaver (ms)
unsigned long powerDelay = sleepDelay + 3600000; //Delay before power off OLED  (ms)
